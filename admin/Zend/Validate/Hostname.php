 ...
 */
require_once '/home/nykhos/Desktop/www/Joomla_2_5_8/administrator/components/com_gdoc/Zend/Validate/Abstract.php';

/**
 * @see Zend_Validate_Ip
 */
require_once '/home/nykhos/Desktop/www/Joomla_2_5_8/administrator/components/com_gdoc/Zend/Validate/Ip.php';
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                    ...
                    if ($this->_options['idn'] &&  isset($this->_validIdns[strtoupper($this->_tld)])) {
                        if (is_string($this->_validIdns[strtoupper($this->_tld)])) {
                            $regexChars += include('/home/nykhos/Desktop/www/Joomla_2_5_8/administrator/components/com_gdoc/' . $this->_validIdns[strtoupper($this->_tld)]);
                        } else {
